...
Public Class FormTanggapanPetugas
	Sub kondisiAwal()
	...
	Private Sub FormTanggapanPetugas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
		munculDataGridView()
		kondisiAwal()
	End Sub
	...
	Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
		...
		Else
			...
			If RichTextBox2.Text = "" Or RichTextBox1.Text = "" Then
				MsgBox("Harap Isi semua data nya denga benar")
			Else
	...
	Private Sub FormTanggapanPetugas_Closed(sender As Object, e As EventArgs) Handles Me.Closed
		Me.Hide()
		MainMenuPetugas.Show()
	End Sub

	Private Sub FormTanggapanPetugas_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
